...
export default props =>
     <header className='Header d-nome d-sm-flex flex-column'>
         ...
         <div className='headerdiv1'>
             ...
             <input type={Text} placeholder='UF'></input><br/>&nbsp;&nbsp;
             <label id='nacionalidade'>Nacionalidade:</label><br/>&nbsp;&nbsp;
             <input type={Text} placeholder='Nacionalidade'></input><br/>&nbsp;&nbsp;
             <label id='datenasc'>Data de nascimento:</label><br/>&nbsp;&nbsp;
             <input type={Date} placeholder='dd/MM/yyyy'></input><br/>&nbsp;&nbsp;
             <label id='estciv'>Estado Civil:</label><br/>&nbsp;&nbsp;
             <input type={Text} placeholder='Estado Civil'></input><br/>&nbsp;&nbsp;
             </div>
             <br/>
             <div className='div4'>
